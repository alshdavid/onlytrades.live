...
The first version of the bot API is modeled after the [CTrader API](https://help.ctrader.com/open-api/messages/). This will be improved on but the inital release will simply be a 1:1 mapping.
