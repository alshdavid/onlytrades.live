use kit_ctrader_proto::ProtoOaDealListByPositionIdRes;
...
impl TryFrom<ProtoOaDealListByPositionIdRes> for DealListByPositionIdRes {
  type Error = anyhow::Error;

  fn try_from(value: ProtoOaDealListByPositionIdRes) -> Result<Self, Self::Error> {
    Ok(DealListByPositionIdRes {
      client_msg_id: None,
